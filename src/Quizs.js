const quiz1 = [
    ...
    {
        question: 'Как называется свойство алгоритма, заключающееся в том, что один и тот же алгоритм можно использовать с разными исходными данными',
        options: [
            'Дискретность',
            'Массовость',
            'Детерминированность',
    ...
    {
        question: 'Как называют программы, предназначенные для перевода в машинные коды программы, написанной на языке высокого уровня?',
        options: [
            'Конденсаторы',
            'Транслитеры',
            'Трансляторы',
    ...
    {
        question: 'Какой язык программирования, созданный в 1957 году, является одним из первых алгоритмических языков и до сих пор применяется для научных вычислений?',
        options: [
            'Ада',
            'Паскаль',
            'Фортран',
    ...
    {
        question: 'Какой язык программирования был создан в 1979 году и назван в честь первого в мире программиста?',
        options: [
            'Фортран',
            'Ада',
            'Паскаль',
